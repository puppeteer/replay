...
Defined in: [Schema.ts:132](https://github.com/puppeteer/replay/blob/main/src/Schema.ts#L132)
...
> **type**: [`Click`](../enumerations/StepType.md#click)

Defined in: [Schema.ts:133](https://github.com/puppeteer/replay/blob/main/src/Schema.ts#L133)
